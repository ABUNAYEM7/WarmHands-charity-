...
const Footer = () => {
  return (
    <footer className="footer justify-items-center content-center lg:grid-cols-3 md:grid-cols-2 grid-cols-1 bg-gradient-to-tr from-[#901111] to-[#007aff] text-white p-10">
      <aside className="flex flex-col items-center justify-center gap-4 text-center">
      ...
      <nav className="space-y-3">
        ...
        <Link to="/donation-process" className="link link-hover">
          Donation Process
        </Link>
      </nav>
      <nav>
