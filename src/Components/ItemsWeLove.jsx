...
const ItemsWeLove = () => {
  return (
    <div>
      <div className="my-6 flex flex-col-reverse lg:flex-row gap-5 justify-center items-center">
        {/* left-container */}
        <div className="w-full lg:w-1/2  bg-[#007aff] rounded-xl animate__animated animate__fadeInLeftBig">
          <h3 className="text-3xl font-bold text-center my-3 text-white flex items-center justify-center gap-2">
            Items We Love 
            <span> <FaFaceGrinHearts size={25} /></span>
          </h3>
        ...
        <div className="w-full lg:w-1/2">
          <img
            className="lg:min-h-[700px] animate__animated animate__lightSpeedInRight"
