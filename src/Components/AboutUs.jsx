...
import { TbTargetArrow, TbClockHour7Filled,TbBinaryTree2  } from "react-icons/tb";
  ...
  return (
    <div className=''>
      ...
      <div className='my-3 flex items-center flex-col justify-center gap-3'>
            ...
            <h3 className='text-3xl font-medium text-[#901111]'>What is WarmHands</h3>
            <p className='text-xl font-medium text-center'>WarmHand is a community-driven website dedicated to helping vulnerable populations during harsh winters by collecting and distributing warm clothing. Our mission is to ensure everyone has access to essential winter gear, such as coats, scarves, and blankets, to stay warm and safe. Users can contribute by donating gently used or new items, volunteering for distribution events, or making monetary donations to support our initiatives. WarmHand fosters a sense of community by bringing people together to spread warmth and kindness. Join us in making a difference, one donation at a time, and help transform lives during the coldest months.</p>
      </div>
      ...
      <div className='flex flex-col md:flex-row justify-between gap-3 my-10'>
        <div className='flex flex-col  justify-center items-center gap-3'>
            ...
            <p className='text-xl font-medium text-center w-2/3'> Our mission is to provide warmth to those in need by facilitating clothing donations, fostering community support, and spreading love through acts of kindness, making a positive impact on lives</p>
        </div>
        <div className='flex flex-col justify-center items-center gap-3'>
            ...
            Our vision is to create a compassionate world where everyone has access to warmth and comfort, building a strong community that supports each other through generous acts of giving</p>
        </div>
      </div>
